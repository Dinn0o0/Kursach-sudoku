        ...
        private void CheckToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < rows; i++)
            {
                ...
                if (f3 > 1)
                {
                    for (int j = 0; j < cols; j++)
                    {
                        if (Convert.ToString(dataGridView1.Rows[i].Cells[j].Value) == "3" && zeroGrid[i, j])
                        {
                            dataGridView1.Rows[i].Cells[j].Style.ForeColor = Color.Red; //красим циферки
                        }
                    }
                ...
                if (f4 > 1)
                {
                    for (int j = 0; j < cols; j++)
                    {
                        if (Convert.ToString(dataGridView1.Rows[i].Cells[j].Value) == "4" && zeroGrid[i, j])
                        {
                            dataGridView1.Rows[i].Cells[j].Style.ForeColor = Color.Red; //красим циферки
                        }
                    }
                ...
                if (f5 > 1)
                {
                    for (int j = 0; j < cols; j++)
                    {
                        if (Convert.ToString(dataGridView1.Rows[i].Cells[j].Value) == "5" && zeroGrid[i, j])
                        {
                            dataGridView1.Rows[i].Cells[j].Style.ForeColor = Color.Red; //красим циферки
                        }
                    }
                ...
                if (f6 > 1)
                {
                    for (int j = 0; j < cols; j++)
                    {
                        if (Convert.ToString(dataGridView1.Rows[i].Cells[j].Value) == "6" && zeroGrid[i, j])
                        {
                            dataGridView1.Rows[i].Cells[j].Style.ForeColor = Color.Red; //красим циферки
                        }
                    }
                ...
                if (f7 > 1)
                {
                    for (int j = 0; j < cols; j++)
                    {
                        if (Convert.ToString(dataGridView1.Rows[i].Cells[j].Value) == "7" && zeroGrid[i, j])
                        {
                            dataGridView1.Rows[i].Cells[j].Style.ForeColor = Color.Red; //красим циферки
                        }
                    }
                ...
                if (f8 > 1)
                {
                    for (int j = 0; j < cols; j++)
                    {
                        if (Convert.ToString(dataGridView1.Rows[i].Cells[j].Value) == "8" && zeroGrid[i, j])
                        {
                            dataGridView1.Rows[i].Cells[j].Style.ForeColor = Color.Red; //красим циферки
                        }
                    }
                ...
                if (f9 > 1)
                {
                    for (int j = 0; j < cols; j++)
                    {
                        if (Convert.ToString(dataGridView1.Rows[i].Cells[j].Value) == "9" && zeroGrid[i, j])
                        {
                            dataGridView1.Rows[i].Cells[j].Style.ForeColor = Color.Red; //красим циферки
                        }
                    }
